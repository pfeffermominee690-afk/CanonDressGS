...
| SUBJECT02-R3-CLEAN-GEOMCAM-002/attempt_002 | R3-CLEAN source geometry/camera contract decomposition | PARTIAL / GC5 | `93e79d6ddfd9204413f97d28504d23e53231f0bd` | `configs/audit/r3_clean_geomcam_contract_v1.yaml` (`8eefbfec...`); zero optimizer steps | no checkpoint loaded; SMPL-X model and sealed evidence SHA exact | `/root/autodl-tmp/canondressgs_work/outputs/pipeline_full/SUBJECT02-R3-CLEAN-GEOMCAM-002/attempt_002` | no-fit source replay IoU min/mean/median `0.928023/0.975762/0.989554`; no flip; Gate A fail; clean Gate B not evaluated; inputs exact |
| SUBJECT02-O00-ARM-SUPPORT-CLOSURE-001/attempt_003 | R3 O00 12k arm-support closure / fixed-open Oracle gate | FAIL / `ARM_SUPPORT_FAIL` / Case C | `5bc0726cc0f5c4d34e8d9f846c582e29d1235cfa` | `configs/audit/o00_arm_support_closure_v1.yaml` (`9dca0e5d...`); 9 deterministic calibration combinations; zero optimizer steps | base `abbf67b5...`; support SHA256 `4119d447a072936d240d7f68e1f70a9e993f8e9abf4501fc1e818fc4cb314541` | `/root/autodl-tmp/canondressgs_work/outputs/pipeline_full/SUBJECT02-O00-ARM-SUPPORT-CLOSURE-001/attempt_003` | 12k subject02-only formal-LBS arm support; repair min `0.782226`; leakage max `0.217774`; covered max `0.035961`; visual WARN; Oracle correctly not run; attempts 1/2 preserved as zero-step tool failures |
