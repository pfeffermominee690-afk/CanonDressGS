...
ALLOWED_PATHS.update({
    ...
    "tools/paper/run_loo_basis_renderer_parity_repair.py",
    "tests/test_explicit_gaussian_residual_basis.py",
    "tests/test_loo_basis_renderer_parity_repair.py",
    "docs/PAPER/AAAI27_LOO_BASIS_RENDERER_PARITY_ROOT_CAUSE_20260724.md",
    "docs/PAPER/AAAI27_LOO_BASIS_NUMERICAL_CLOSURE_20260724.md",
    "docs/PAPER/AAAI27_LOO_RESIDUAL_TO_RENDER_STATE_AUDIT_20260724.md",
    "docs/PAPER/AAAI27_LOO_BASIS_RENDERER_PARITY_REPAIR_20260724.md",
    "paper_protocol/reviewer_risk/loo_basis_renderer_parity_root_cause.json",
    "paper_protocol/reviewer_risk/loo_renderer_determinism_floor.json",
    "paper_protocol/reviewer_risk/loo_residual_channel_parity_analysis.json",
    "paper_protocol/reviewer_risk/loo_render_state_layer_parity_analysis.json",
    "paper_protocol/reviewer_risk/loo_basis_numerical_closure_analysis.json",
    "paper_protocol/reviewer_risk/loo_affine_rank3_closure_analysis.json",
    "paper_protocol/reviewer_risk/loo_coefficient_solver_audit.json",
    "paper_protocol/reviewer_risk/loo_composition_semantics_audit.json",
    "paper_protocol/reviewer_risk/loo_all_split_basis_parity_repaired.json",
    "paper_protocol/reviewer_risk/loo_basis_renderer_parity_execution_contract_repaired.json",
    "paper_protocol/reviewer_risk/loo_basis_renderer_parity_repair_tests.json",
